...
<!-- 								</p> -->
								...
								<label for="book" > Book </label>
                                 ...
                                 <option ${b4}  hidden="hidden" value="4">Numbers
                                  <option ${b5} value="5">Deuteronomy
                                   
                                 </select>
                                
                                 <label for="chapter" > Chapter </label>
                                
                                 <input maxlength="2" id="chapter" name="p"  style="padding:0px;width:30px;height:25px" type="number" min="1" max="99"  value="${c}" />
