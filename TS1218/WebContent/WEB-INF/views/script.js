...
function myReset() {
	...
	document.getElementById("Skip").setAttribute("style",
			"background-color: 90CAF9");
	document.getElementById("AC").disabled = true;
	document.getElementById("AC").setAttribute("style",
			"background-color: #f0f0f0");
	document.getElementById("PC").disabled = true;
	document.getElementById("PC").setAttribute("style",
			"background-color: #f0f0f0");
}

function trwChanged() {
	document.getElementById("NE").disabled = true;
	document.getElementById("NE").setAttribute("style",
			"background-color: #f0f0f0");
